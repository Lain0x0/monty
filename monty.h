...
void file_push(stack_t **head, unsigned int number);
void file_pall(stack_t **head, unsigned int number);
void file_pint(stack_t **head, unsigned int number);
...
void file_pstr(stack_t **head, unsigned int counter);
void file_rotl(stack_t **head, unsigned int counter);
void file_rotr(stack_t **head, __attribute__((unused)) unsigned int counter);
